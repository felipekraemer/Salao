...
CREATE TABLE `participacao` (
  `codigo_publicador` int(11) NOT NULL,
  `data` date NOT NULL,
  `participacao` varchar(45) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`codigo_publicador`,`data`),
  CONSTRAINT `FK_Publicador` FOREIGN KEY (`codigo_publicador`) REFERENCES `publicadores` (`codigo`)
